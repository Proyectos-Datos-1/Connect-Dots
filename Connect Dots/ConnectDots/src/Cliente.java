...
public class Cliente extends Application {
    ...
    private void connectToServer() {
        try {
            ...
            // Crear un hilo para escuchar y procesar las coordenadas del servidor
                ...
                try {
                    while (true) {
                        ...
                        if (startCircle != null && endCircle != null) {
                            Platform.runLater(() -> drawLine(startCircle, endCircle)); // Utiliza Platform.runLater para actualizar la interfaz de usuario
                        }
                    }
            ...
            serverListenerThread.setDaemon(true); // Configurar el hilo como daemon para que se detenga cuando la aplicación se cierre
            serverListenerThread.start(); // Iniciar el hilo para escuchar al servidor
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
